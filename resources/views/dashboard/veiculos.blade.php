...
$(document).ready(function() {
    $('#veiculo').change(function() {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { veiculo: selectedVehicle },
            success: function(response) {
                console.log(response); // Verifique o formato dos dados recebidos
                
                $('#marca1').empty(); // Limpa o select antes de adicionar os novos dados
    ...
    $('#marca1').change(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#modelo1').empty(); // Limpa o select antes de adicionar os novos dados
